...
const string strMessageMagic = "MEDIUM Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MEDIUM
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // MEDIUM: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MEDIUM", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MEDIUM";
        CTransaction txNew;
        txNew.nTime = 1465583842;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1465583843;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 273770; // !fTestNet ? 1575379 : 46534;
		
       
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x291b0f57c0b2217208c63e931c292be45525f103cff453043e2e32e64c9c38aa"));
...
unsigned char pchMessageStart[4] = { 0xf4, 0x98, 0xe3, 0xb5 };
