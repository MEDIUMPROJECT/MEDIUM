...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MPRO");
    case mBTC: return QString("mMPRO");
    case uBTC: return QString::fromUtf8("μMPRO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MEDIUMs"));
    case mBTC: return QString(QObject::tr("Milli-MEDIUMs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MEDIUMs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
