...
DESCRIPTION="MEDIUM - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/MEDIUM-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "MEDIUM" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/MEDIUM-qt.protocol ${PN}.protocol
	fi
}
